...
object Constants {
    ...
    var GPT_ORDER_DEV_MESSAGE = """
        ...
        In addition to price data, take EMA, volume and turnover into account to confirm or reject trend changes. Avoid trades that go against a strong trend.
        ...
        - The take profit should ideally be at least twice the distance of the stop loss (2:1 reward:risk ratio).
